@echo off
REM ============================================================
REM  build_and_inject.bat — Windows v31 稳定离线版 IPA 注入脚本
REM
REM  用法: build_and_inject.bat <输入.ipa> [输出.ipa]
REM  示例: build_and_inject.bat AM_v1.ipa AM_v1_direct_v31.ipa
REM
REM  前提:
...
set INPUT_IPA=%1
set OUTPUT_IPA=%2
if "%OUTPUT_IPA%"=="" set OUTPUT_IPA=AM_v1_direct_v31.ipa
