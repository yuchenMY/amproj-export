...
class CloudSyncSourceTests(unittest.TestCase):
    ...
    def test_editor_buttons_are_customized_only_on_project_edit_controller(self):
        ...
        self.assertIn("AMEditorMirroredQuickActionsButton", EDITOR)
        self.assertIn("center.x >= CGRectGetMidX(root.bounds)", EDITOR)
        self.assertIn("fabs(center.y - addCenter.y)", EDITOR)
